  ...
  return (
    <div className="bg-white min-h-screen text-gray-800 px-6 py-12">
      ...
      <section className="max-w-5xl mx-auto space-y-6 text-justify">
        <p>
          <strong>ANT TECHNOLOGY</strong> accompagne ses clients de l'idée à la publication sur les stores : étude fonctionnelle, design UI/UX, développement, tests, déploiement et support.
        </p>
        <p>
